...
public:
    ...
    void set(value_type val) { pthread_mutex_lock(&mutex); value = val; pthread_mutex_unlock(&mutex);}
    value_type get() const { value_type ret; pthread_mutex_lock((pthread_mutex_t*)&mutex); ret = value; pthread_mutex_unlock((pthread_mutex_t*)&mutex); return ret;}
private:
    value_type value;

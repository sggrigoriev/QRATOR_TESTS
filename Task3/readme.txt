...
Тесты:
    ...
    2.0 Задание выходит на паузу N ceк. После этого печатает сообщение.
    ...
    6.0 Аварийное завершение треда по ошибке стека. Воркер должен стать доступным для следующих задач
    6.1 Аварийное завершение треда по ошибке динамической памяти. Воркер должен стать доступным для следующих задач
    6.2 Аварийное завершение треда по ошибке "Деление на ноль". Воркер должен стать доступным для следующих задач
